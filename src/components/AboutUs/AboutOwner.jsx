...
const AboutOwner = () => {
  ...
  return (
    <motion.div
      ref={ref}
      className="max-w-4xl mx-4 md:mx-auto p-6 bg-white my-20 shadow-2xl rounded-2xl"
    ...
    >
      <div className="flex flex-col md:flex-row items-center gap-8 min-h-[300px]">
        ...
        <div
          className="rounded-full bg-green-600 p-4 flex justify-center items-center
                     w-48 h-48 md:w-64 md:h-64 mx-auto md:mx-0 flex-shrink-0"
        >
          <img
        ...
        {/* Right side: Owner intro centered vertically & horizontally */}
        <div className="w-full md:flex-1 flex justify-center items-center text-center md:text-left">
          <div>
            ...
            <p className="text-gray-700 leading-relaxed">
              ...
              years of experience in real estate, I am committed to helping you
              find your dream home. Passionate about delivering quality and
              trust in every deal.
            </p>
          </div>
        </div>
